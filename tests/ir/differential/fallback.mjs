...
try {
    ...
    const cpu=vm.v86.cpu,e=cpu.wm.exports,w=new Uint32Array(e.memory.buffer),PC=0x100000;
    ...
    function prepare(bytes){
        ...
        cpu.is_32[0]=cpu.stack_size_32[0]=1;cpu.reg32.fill(0);cpu.reg32[4]=0x90000;cpu.instruction_pointer[0]=PC;w[664>>2]=0;
    ...
    assert.equal(w[664>>2],(cpu.reg32[0]*2-(cpu.instruction_pointer[0]===PC+1?1:0))>>>0);
    ...
    const iterations=(w[664>>2]+(cpu.instruction_pointer[0]===PC+4?1:0))/2;
