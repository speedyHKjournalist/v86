(module
  ...
  (type $t4 (func (param i64 i32 i32)))
  ...
  (import "e" "ir_rmw_read" (func $e.ir_rmw_read (type $t3)))
  (import "e" "ir_rmw_value" (func $e.ir_rmw_value (type $t1)))
  (import "e" "ir_rmw_write" (func $e.ir_rmw_write (type $t4)))
  (import "e" "ir_hlt" (func $e.ir_hlt (type $t1)))
  (import "e" "m" (memory {normalised output}))
  (func $f (export "f") (type $t5) (param $p0 i32)
    (local $l1 i32) (local $l2 i32) (local $l3 i32) (local $l4 i32) (local $l5 i32) (local $l6 i32) (local $l7 i32) (local $l8 i32) (local $l9 i32) (local $l10 i32) (local $l11 i32) (local $l12 i32) (local $l13 i32) (local $l14 i32) (local $l15 i64) (local $l16 i32) (local $l17 i32) (local $l18 i32) (local $l19 i64) (local $l20 i32) (local $l21 i32) (local $l22 i32) (local $l23 i32) (local $l24 i32) (local $l25 i32) (local $l26 i32)
    (if $I0
      (local.get $p0)
      (then
        (return)))
