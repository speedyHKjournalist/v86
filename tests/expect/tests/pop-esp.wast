(module
  ...
  (type $t4 (func (param i32 i32) (result i64)))
  ...
  (import "e" "ir_pop_address" (func $e.ir_pop_address (type $t3)))
  (import "e" "ir_segment_address" (func $e.ir_segment_address (type $t4)))
  (import "e" "ir_admission_barrier" (func $e.ir_admission_barrier (type $t2)))
  (import "e" "ir_memory_read" (func $e.ir_memory_read (type $t4)))
