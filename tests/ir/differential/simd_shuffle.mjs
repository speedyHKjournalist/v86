...
for(const release of [false,true]){
 ...
 try {
    ...
    const chain=extra("chain"),resume=extra("resume"),chain_bytes=JSON.parse(fs.readFileSync("build/ir-simd-shuffle/chain.json"));
    ...
    const base_case=cases.findIndex(c=>c[1]&&c[2]===32&&c[3]===0x0FC6&&c[6]===0&&c[7]===8);
